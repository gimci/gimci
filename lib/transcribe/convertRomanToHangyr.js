...
var compose = function compose(str) {
  ...
  var initialId = getByRoman(lettersSegmented[0], _bagsynghienRule.INITIAL);
  var medialId = getByRoman(lettersSegmented[1].toLowerCase(), _bagsynghienRule.MEDIAL);
  var finalId = lettersSegmented.length >= 2 ? getByRoman(lettersSegmented[2], _bagsynghienRule.FINAL) : undefined;

  var charCode = 0xAC00 + 28 * 21 * initialId + 28 * medialId + finalId;
 ...
 */
/**/
var getByRoman = function getByRoman(ro, haystack) {
